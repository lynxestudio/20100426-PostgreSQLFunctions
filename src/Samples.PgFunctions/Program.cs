...
NpgsqlConnectionStringBuilder builder = new NpgsqlConnectionStringBuilder(cStr);
...
lbMsg.Text = txtNameFunction.Text + "(" + txtArg.Text +") on " + builder.Database +" = " + resp; 
}}catch(Exception e){
